...
{
cout <<"|-------------------------------------|"<<endl;
cout <<"| Author   : XNUVERS007               |"<<endl;
cout <<"| You Tube : https://bit.ly/Xnuvers   |"<<endl;
cout <<"| github   : https://bit.ly/Xnuvrs1   |"<<endl;
cout <<"| Facebook : https://bit.ly/Fesbuck   |"<<endl;
cout <<"| Instagram: https://bit.ly/Xnvrs13   |"<<endl;
cout <<"| Site     : http://bit.ly/Mykingbee  |"<<endl;
cout <<"|-------------------------------------|";
cout <<endl;
	string password;
																				...
																				switch(alphabetSet)
																					{
																						...
																						break;
																							...
																							for(digit[0]=1;digit[0]<alphabet.length();digit[0]++)
																							{
																								attempt++; if(attempt%2500000==0)
																								cout << "."; test=alphabet[digit[0]];
																								for(int i=1;i<passwordLength;i++)
																									if(alphabet[digit[i]]!='-')
																									test+=alphabet[digit[i]];
																									if(pass.compare(test)==0)
																														...
																														for(int i=1;i<passwordLength;i++)
																															...
																															if(pass.compare(test)==0)
																															{
																																...
																																alphabetSet++;
																																	...
																																	break;
																																		case 5: alphabetSet=1;
																																			while(alphabetSet<8){ switch(alphabetSet)
																																			{
																																				case 1 : alphabet = "-0123456789";
																																				cout << endl << endl <<"Testing only digits(0123456789) - 10 Characters, please wait";
																																				break;
																																								...
																																								switch(alphabetSet)
																																								{
																																									...
																																									break;
																																										...
																																										for(digit[0]=1;digit[0]<alphabet.length();digit[0]++)
																																										{
																																											...
																																											if(attempt%2500000==0)
																																												cout << ".";
																																													test=alphabet[digit[0]]; for(int i=1;i<passwordLength;i++)
																																													if(alphabet[digit[i]]!='-')
																																														test+=alphabet[digit[i]];
																																													if(pass.compare(test)==0)
																																													{
